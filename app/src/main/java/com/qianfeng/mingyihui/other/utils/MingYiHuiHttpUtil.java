 ...
 * @date : 16/1/12.
 */
public class MingYiHuiHttpUtil
{
     ...
     * @return
     */
    public static File downLoadFile(File dir,String fileName,String src,MingYiHuiTask.UpgradeProgress upgradeProgress){
